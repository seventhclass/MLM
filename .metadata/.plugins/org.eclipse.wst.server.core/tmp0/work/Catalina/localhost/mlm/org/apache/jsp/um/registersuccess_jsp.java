 ...
 * Generated at: 2015-05-15 21:51:32 UTC
...
public final class registersuccess_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/registersuccess.js\"></script>\t\t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t");
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"alert alert-success\" role=\"alert\"><strong>Congratulations ");
 String username; username=(user.getCompanyName()!=""&&user.getCompanyName()!=null) ? user.getCompanyName() : user.getLastName()+" "+user.getFirstName(); out.print(username);  
      out.write("!</strong> You have successfully registered member.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>Your member id is: <strong id=\"memberid\" style=\"color:red\">");
      out.print(user.getUserId());
      out.write("</strong> keep in mind,plese.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>At the same time we have sent the registration information to your mailbox(<strong style=\"color:blue\">");
      out.print(user.getEmail());
      out.write("</strong>), please check and properly preserved.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>Thank you!</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div> \r\n");
      out.write("\t\t\t\t\t\t<div class=\"row text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t<div id=\"regsuccess\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button id=\"goLogin_btn\" type=\"button\" class=\"btn btn-primary\">OK</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
