 ...
 * Generated at: 2015-07-14 21:30:38 UTC
...
public final class productmaintenance_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<link href=\"");
      out.print(request.getContextPath());
      out.write("/css/productmaintenance.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/js/plugin/ajaxfileupload.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/mlm.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/productmaintenance.js\"></script>\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"h2\">Product Maintenance</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"subtitle\" >Product List</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Whole Sale Price Each</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Retail Price Each</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Currency</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Numbers of Capsules</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Business Volume Each</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Business Volume2 Each</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   <tbody id=\"productlist\" class=\"pdt_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t       \t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t           \r\n");
      out.write("\t\t\t\t\t\t\t\t\t   </tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t </table>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 pdt_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success addproductbtn\" data-toggle=\"modal\" data-target=\".productmaintenance\" data-backdrop=\"static\" >Add New Item <span class=\"glyphicon glyphicon-plus-sign\"></span></button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
	...
	out.println("Copyright © 2015 <a href='http://7thclass-smallfoots.rhcloud.com/' target='_blank'>7thclass</a> All Rights Reserved.");
      ...
      out.write("\t</div>\r\n");
      out.write("\t \r\n");
      out.write("\t<div class=\"modal fade bs-example-modal-lg productmaintenance\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<h4 class=\"modal-title text-center\">Products Maintenance</h4>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<form id=\"editProductForm\" class=\"form-horizontal\" role=\"form\" action=\"/addProduct\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"productid\" data-model=\"\" id=\"productid\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"itemcode\" class=\"col-sm-3 control-label\">Item Code</label>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"category\" class=\"col-sm-3 control-label\">Category\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<select id=\"categoryselect\" name=\"categoryselect\" class=\"form-control\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"currency\" class=\"col-sm-3 control-label\">Currency</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<select id=\"currencyselect\" name=\"currencyselect\" class=\"form-control\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"w_price\" class=\"col-sm-3 control-label\">Whole Sale Price</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"w_price\" name=\"w_price\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"r_price\" class=\"col-sm-3 control-label\">Retail Price</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"r_price\" name=\"r_price\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"numbers\" class=\"col-sm-3 control-label\">Numbers of Capsules</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"numbers\" type=\"number\" name=\"numbers\" min=\"1\" max=\"9999\" value=\"1\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"volume\" class=\"col-sm-3 control-label\">Business Volume</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"volume\" class=\"form-control\" id=\"volume\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"volume2\" class=\"col-sm-3 control-label\">Business Volume2</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"volume2\" class=\"form-control\" id=\"volume2\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"description\" class=\"col-sm-3 control-label\">Description</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea id=\"description\" name=\"description\" class=\"form-control\" rows=\"2\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-footer text-center\">\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<button id=\"editProductbtn\" type=\"submit\" class=\"btn btn-primary\">Save</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t \r\n");
      out.write("\t<div id=\"productcancel\" class=\"modal fade bs-example-modal-sm\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<form id=\"cancelProductForm\" class=\"form-horizontal\" role=\"form\" action=\"\">\r\n");
      ...
      out.write("\t\t\t\t\t<button id=\"delProductbtn\" type=\"submit\" class=\"btn btn-primary\">Yes</button>\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t<div class=\"modal fade bs-example-modal-lg productimg\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t<div class=\"modal-dialog modal-lg\">\r\n");
      out.write("\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-header\" style=\"background-color:#428bca;color:#fff;border-top-right-radius: 3px;border-top-left-radius: 3px;padding: 5px;\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\r\n");
      out.write("\t\t\t\t\t<h4 class=\"modal-title text-center\">Products Image Maintenance</h4>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<form id=\"editProductImgForm\" class=\"form-horizontal\" role=\"form\" action=\"");
      out.print(request.getContextPath());
      out.write("/delProductImages\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-footer text-center\">\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<form id=\"uploadProductImgForm\" class=\"form-horizontal\"\r\n");
      out.write("\t\t\t\t\t\t  role=\"form\"\r\n");
      out.write("\t\t\t\t\t\t  action=\"");
      out.print(request.getContextPath());
      out.write("/uploadImageFile\"\r\n");
      out.write("\t\t\t\t\t\t  method=\"post\"\r\n");
      out.write("\t\t\t\t\t\t  enctype=\"multipart/form-data\"\r\n");
      out.write("\t\t\t\t\t\t  target=\"hidden_frame\" >\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t    \t\t\t\t\t<input type=\"file\" id=\"uploadFile\" name=\"uploadFile\" siez=\"16\" class=\"form-control\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t  enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"uploadfile\" class=\"col-sm-3 control-label\">Select upload file:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t    \t\t\t\t\t<input type=\"file\" id=\"uploadFile\" name=\"uploadFile\" siez=\"16\" class=\"form-control\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"productId\" name=\"productId\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3 text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button id=\"uploadFilebtn\" type=\"submit\" class=\"btn btn-primary\">Upload</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>  -->\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/mlm/js/productmaintenance.js\"></script>\t\r\n");
      out.write("\t <script>\r\n");
      out.write("  \t\t$(function(){\r\n");
      out.write("  \t\t\t $('[data-toggle=\"tooltip\"]').tooltip();\r\n");
      out.write("  \t\t\t $('.editproductbtn').tooltip({\r\n");
      out.write("  \t\t       title:\"Edit\",\r\n");
      out.write("  \t\t       placement:'right'\r\n");
      out.write("  \t\t    });\r\n");
      out.write("  \t\t\t$('.delproductbtn').tooltip({\r\n");
      out.write("   \t\t       title:\"Delete\",\r\n");
      out.write("   \t\t       placement:'right'\r\n");
      out.write("   \t\t    });\r\n");
      out.write("  \t\t\t$('.editproductimgbtn').tooltip({\r\n");
      out.write("   \t\t       title:\"Upload Images\",\r\n");
      out.write("   \t\t       placement:'right'\r\n");
      out.write("   \t\t    });\r\n");
      out.write("  \t\t});\r\n");
      out.write("  </script>\r\n");
      ...
      out.write("\r\n");
      out.write(" \t\t\tdocument.getElementById(\"uploadFile\").outerHTML = document\r\n");
      out.write("\t\t\t\t.getElementById(\"uploadFile\").outerHTML;\r\n");
      out.write("\t\t\tdocument.getElementById(\"msg\").innerHTML = \"<font color=red>Upload file \"\r\n");
      out.write("\t\t\t\t+ msg + \".</font>\"; \r\n");
      out.write("\t\t\tif (msg == \"Success\") {\r\n");
      out.write("\t\t\t\tvar productid = document.getElementById(\"productId\").value;\r\n");
      out.write("\t\t\t\talert(\"productid=\" + productid);\r\n");
      out.write("\t\t\t\tqueryProductImages(productid);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("\r\n");
