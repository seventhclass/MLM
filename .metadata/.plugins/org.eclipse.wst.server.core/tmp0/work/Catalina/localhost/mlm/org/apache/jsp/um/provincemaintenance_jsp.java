 ...
 * Generated at: 2015-07-14 21:30:58 UTC
...
public final class provincemaintenance_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/provincemaintenance.js\"></script>\t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"h2\">Province Maintenance</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"subtitle\" >Country Selection</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"country\" class=\"col-sm-offset-1 col-sm-1 control-label\">Country</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<select id=\"countrymenu\" class=\"form-control\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"subtitle\" >Province List</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>ID</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Province Name</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Province Code</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   <tbody id=\"provincelist\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <!-- <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t<td>1</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>Quebec</td>\r\n");
      out.write("\t\t\t\t\t\t           \t\t\t<td>QC</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-offset-1 col-sm-4 pvn_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-success editprovincebtn\" data-toggle=\"modal\" data-target=\".provincemaintenance\" data-backdrop=\"static\" >Edit</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-4\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#provincecancel\" data-backdrop=\"static\" >Delete</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t<td>2</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>Ontario</td>\r\n");
      out.write("\t\t\t\t\t\t           \t\t\t<td>ON</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-offset-1 col-sm-4 pvn_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-success editprovincebtn\" data-toggle=\"modal\" data-target=\".provincemaintenance\" data-backdrop=\"static\" >Edit</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-4\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-danger delprovincebtn\" data-toggle=\"modal\" data-target=\"#provincecancel\" data-backdrop=\"static\" >Delete</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>  -->\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 pvn_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success addprovincebtn\" data-toggle=\"modal\" data-target=\".provincemaintenance\" data-backdrop=\"static\" >Add New Item <span class=\"glyphicon glyphicon-plus-sign\"></span></button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
	...
	out.println("Copyright © 2015 <a href='http://7thclass-smallfoots.rhcloud.com/' target='_blank'>7thclass</a> All Rights Reserved.");
      ...
      out.write("\t</div>\r\n");
      out.write("\t \r\n");
      out.write("\t<div class=\"modal fade bs-example-modal-lg provincemaintenance\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<h4 class=\"modal-title text-center\">Province Maintenance</h4>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<form id=\"editProvinceForm\" class=\"form-horizontal\" role=\"form\" action=\"\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control\" id=\"countryid\" >\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"provincename\" class=\"col-sm-3 control-label\">Province\r\n");
      out.write("\t\t\t\t\t\t\t\tName</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"provincename\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"provincecode\" class=\"col-sm-3 control-label\">Province\r\n");
      out.write("\t\t\t\t\t\t\t\tCode</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"provincecode\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</form>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t \r\n");
      out.write("\t<div id=\"provincecancel\" class=\"modal fade bs-example-modal-sm\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<form id=\"cancelProvinceForm\" class=\"form-horizontal\" role=\"form\" action=\"\">\r\n");
