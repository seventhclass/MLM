 ...
 * Generated at: 2015-06-10 22:35:35 UTC
...
public final class autoship_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"subtitle\" >Autoship Order for: ABCDE00001</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"left_panel\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"panel panel-default\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t<div class=\"col-sm-offset-1 col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t\tAutoship Pay Method\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t<div class=\"col-sm-offset-1 col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<select id=\"a_paymethod\" class=\"form-control\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option selected value=\"0\">Please Choose...</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option value=\"1\">Credit Card</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option value=\"2\">Paypal</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t</div>\t\t\t\t\t\t\t\t\t    \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"right_panel\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"panel panel-default\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t<div class=\"col-sm-offset-1 col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t\tPlease select currency:\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<select id=\"a_paymethod\" class=\"form-control\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option selected value=\"0\">Please Choose...</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option value=\"1\">CAD Dollars</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option value=\"2\">US Dollars</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t</div>\t\t\t\t\t\t\t\t\t    \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t   <tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t<td><input type=\"number\" name=\"quantity\" min=\"0\" max=\"999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>A000000001</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>Prolo telomeres anti-oxidauil ....</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t           \t\t<td>Second Generation of MT-1000</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t           \t\t<td>Preulsor of a miracle moleeule</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"shipfeebox\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success\" data-toggle=\"modal\" data-target=\"#productlist\" data-backdrop=\"static\" >Products List <span class=\"glyphicon glyphicon-circle-arrow-down\"></span></button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"rstar_fee_default\" value=\"1\" checked>Default\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"rstar_fee_once\" value=\"2\" >Once\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"rstar_fee_permanent\" value=\"2\" >Permanent\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3 text-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tRestart Aship Fee $ \t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"rstart_fee\" value=\"0\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"ship_fee_default\" value=\"1\" checked>Default\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"ship_fee_once\" value=\"2\" >Once\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"ship_fee_permanent\" value=\"2\" >Permanent\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3 text-right\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"ship_fee\" value=\"10.00\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"insurance_fee_default\" value=\"1\" checked>Default\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"insurance_fee_once\" value=\"2\" >Once\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"insurance_fee_permanent\" value=\"2\" >Permanent\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3 text-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tInsurance Fee $ \t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"insurance_fee\" value=\"0\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"eclc_fee_default\" value=\"1\" checked>Default\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"eclc_fee_once\" value=\"2\" >Once\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"eclc_fee_permanent\" value=\"2\" >Permanent\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label> \t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3 text-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tE-Collect Fee $ \t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"eclc_fee\" value=\"0\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"shipfeebox\">\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-offset-6 col-sm-3 text-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tTax $ \t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"tax_fee\" value=\"0\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"row ashipdatestyle\">\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"ashipdate\" class=\"col-sm-3\">Date of last Autoship:</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"date\" id=\"ashipdate\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2\" >Total:</label>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$232.00\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"row ashipdatestyle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-sm-2\">Order Number:</label>17440\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"ashipdatebox\">\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row ashipdatestyle\">\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-offset-3 col-md-7 text-danger text-center\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\tPlease keep in mind this amount does not include taxes and shipping,\r\n");
      out.write("\t\t\t\t\t\t\t\t\tplease adjust accordingly.\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row ashipdatestyle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-12 text-center\">\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm \">Skip Next Autoship</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm \">Cancel Autoship</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm \">Update Next Autoship Date</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm \">Process Autoship Now</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm \">Update</button>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
