 ...
 * Generated at: 2015-05-23 18:38:34 UTC
...
public final class currencymaintenance_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/currencymaintenance.js\"></script>\t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"h2\">Currency Maintenance</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"subtitle\" >Currency List</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>ID</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Currency Name</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Abbreviation</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   <tbody id=\"currencylist\" class=\"cur_maintenance\">\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>1</td>\t\t\t\t\t\t\t     \r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>Canada Dollar</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>CA</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-offset-1 col-sm-4 cur_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-success editcurrencybtn\" data-toggle=\"modal\" data-target=\".currencymaintenance\" data-backdrop=\"static\" >Edit</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-4\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#currencycancel\" data-backdrop=\"static\" >Delete</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t</td>\t\t\t\t\t\t           \t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t<td>2</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>United States Dollar</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>US</td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-offset-1 col-sm-4 cur_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-success editcurrencybtn\" data-toggle=\"modal\" data-target=\".currencymaintenance\" data-backdrop=\"static\" >Edit</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t<div class=\"col-sm-4 cur_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t\t<button type=\"button\" class=\"btn btn-danger delcurrencybtn\" data-toggle=\"modal\" data-target=\"#currencycancel\" data-backdrop=\"static\" >Delete</button>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t           \t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr> \t -->\t\t\t\t\t\t\t\t     \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 cur_maintenance\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success addcurrencybtn\" data-toggle=\"modal\" data-target=\".currencymaintenance\" data-backdrop=\"static\" >Add New Item <span class=\"glyphicon glyphicon-plus-sign\"></span></button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
	...
	out.println("Copyright © 2015 <a href='http://7thclass-smallfoots.rhcloud.com/' target='_blank'>7thclass</a> All Rights Reserved.");
      ...
      out.write("\t</div>\r\n");
      out.write("\t \r\n");
      out.write("\t<div class=\"modal fade bs-example-modal-lg currencymaintenance\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<h4 class=\"modal-title text-center\">Currency Maintenance</h4>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<form id=\"editCurrencyForm\" class=\"form-horizontal\" role=\"form\" action=\"\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"currencyname\" class=\"col-sm-3 control-label\">Currency\r\n");
      out.write("\t\t\t\t\t\t\t\tName</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"currencyId\" data-model=\"\" id=\"currencyid\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"currencyName\" class=\"form-control\" id=\"currencyname\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"currencyabbr\" class=\"col-sm-3 control-label\">Abbreviation</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"currencyAbbr\" class=\"form-control\" id=\"currencyabbr\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</form>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-footer text-center\">\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<button id=\"editCurrencybtn\" type=\"button\" class=\"btn btn-primary\">Save</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t \r\n");
      out.write("\t<div id=\"currencycancel\" class=\"modal fade bs-example-modal-sm\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<form id=\"cancelCurrencyForm\" class=\"form-horizontal\" role=\"form\" action=\"\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t<button id=\"delCurrencybtn\" type=\"button\" class=\"btn btn-primary\">Yes</button>\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
