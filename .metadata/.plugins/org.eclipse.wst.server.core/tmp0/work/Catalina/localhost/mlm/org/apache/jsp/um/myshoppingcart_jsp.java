 ...
 * Generated at: 2015-07-14 19:08:39 UTC
...
public final class myshoppingcart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<link href=\"");
      out.print(request.getContextPath());
      out.write("/css/myshoppingcart.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/myshoppingcart.js\"></script>\t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t<div id=\"showcart\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-offset-2 col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<div id=\"cartlist\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"panel panel-info\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"panel-heading text-center\"><span class=\"glyphicon glyphicon-shopping-cart\"></span>\t\tMy shopping cart</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"p_item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<table class=\"table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t   <tbody id=\"shoppingCartList\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t \t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t           \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t   </tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t </table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"list-group-item-text\">Total Quantity: <span id=\"total_qty\"></span></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"list-group-item-text\">Total Amount: $<span id=\"total_amt\"></span></p>\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"panel-footer text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button id=\"makeOrder_btn\" type=\"button\" class=\"btn btn-danger\">Make Order</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/products\"><button type=\"button\" class=\"btn btn-primary\">Continue Shopping</button></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div> <!-- end showcart -->\t\r\n");
