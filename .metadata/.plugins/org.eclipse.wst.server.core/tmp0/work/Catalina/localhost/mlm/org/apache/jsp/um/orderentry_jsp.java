 ...
 * Generated at: 2015-05-30 02:10:59 UTC
...
public final class orderentry_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<link href=\"");
      out.print(request.getContextPath());
      out.write("/css/orderentry.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/js/orderentry.js\"></script>\t\t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if(userId==null || userId==""){
      ...
      out.write("\t\t\t\t\t\t<div id=\"orderentry\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"list-group\">\r\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"list-group-item list-group-item-info active\"><span class=\"glyphicon glyphicon-list-alt\"></span> My Order </div>\r\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"list-group-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"row\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tMember ID: <span id=\"memberId\">ABCDE00001</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-4\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span id=\"memberName\">Michael Wang</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-5\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"list-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"list-group-item list-group-item-danger\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img style=\"width: 80px; height: 80px; padding: 10px;\" src=\"");
      out.print(request.getContextPath());
      out.write("/images/logo/shopping-cart-icon-transparent.png\" alt=\"shopping cart\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-7 text-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tShopping Cart Item: <span id=\"shoppingCartItemNumber\">3</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tTotal: $<span id=\"shoppingCartTotalAmt\">222.00</span> CAD\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div id=\"order_cart\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a id=\"clearShoppingCart\" href=\"#\">[Clear]</a> <a id=\"checkoutShoppingCart\" href=\"#\">[Checkout]</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"list-group-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"subtitle\" >Order Checkout</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Volume 2</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Price Total</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Points Total</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t   <tbody id=\"myOrderList\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td>2015-03-15 10:20</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>A000000001</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>MT-1000</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td><input class=\"numbers\" type=\"number\" name=\"numbers\" data-id=\"1\" data-seq=\"1\" min=\"1\" max=\"9999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>99.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>90</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td id=\"subPriceTotal_id_11\">$99.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td id=\"subPointsTotal_id_11\">9</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td style=\"width:30px\"><span data-id=\"1\" data-seq=\"1\" class=\"glyphicon glyphicon-remove-sign close_item\" style=\"color:red\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     </tr>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td>2015-03-15 10:20</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>A000000002</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>MT-1000B</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td><input class=\"numbers\" type=\"number\" name=\"numbers\" data-id=\"1\" data-seq=\"2\" min=\"1\" max=\"9999\" value=\"2\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>41.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>25</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td id=\"subPriceTotal_id_12\">$41.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td id=\"subPointsTotal_id_12\">4</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td style=\"width:30px\"><span data-id=\"1\" data-seq=\"2\" class=\"glyphicon glyphicon-remove-sign close_item\" style=\"color:red\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     </tr> \t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td>2015-04-04 13:22</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>A000000003</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>Rejwvienator</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td><input class=\"numbers\" type=\"number\" name=\"numbers\" data-id=\"1\" data-seq=\"3\" min=\"1\" max=\"9999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>82.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td>30</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td id=\"subPriceTotal_id_13\">$82.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td id=\"subPointsTotal_id_13\">8</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           \t\t<td style=\"width:30px\"><span data-id=\"1\" data-seq=\"3\" class=\"glyphicon glyphicon-remove-sign close_item\" style=\"color:red\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td colspan=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td>Total:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td id=\"VolumTotal\">145</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td id=\"PriceTotal\">$222.00</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     \t<td id=\"PointsTotal\">21</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     </tr> \t\t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t       \t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t           \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t   </tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t </table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <div>\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<form id=\"addProductForm\" class=\"form-horizontal\" role=\"form\" action=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success productsList_btn\" data-toggle=\"modal\" data-target=\"#productlist\" data-backdrop=\"static\" >Products List <span class=\"glyphicon glyphicon-circle-arrow-down\"></span></button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"itemcode\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Item Code\">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tQty:<input id=\"itemqty\" type=\"number\" name=\"quantity\" min=\"1\" max=\"999\" value=\"1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-offset-4 col-sm-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success\">Add Item <span class=\"glyphicon glyphicon-plus-sign\"></span></button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div id=\"finish_order\" class=\"text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/payandship\"><button type=\"button\" class=\"btn btn-primary\">Finished Order <span class=\"glyphicon glyphicon-ok-sign\"></span></button></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"list-group-item\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/products\">Countinue Shopping</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div> <!-- end orderentry -->\t\t\t\t\t\t\t\r\n");
	...
	out.println("Copyright © 2015 <a href='http://7thclass-smallfoots.rhcloud.com/' target='_blank'>7thclass</a> All Rights Reserved.");
      ...
      out.write("\t</div>\r\n");
      out.write("\t \t\r\n");
      out.write("\t<div id=\"productlist\" class=\"modal fade bs-example-modal-lg\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t<h4 class=\"modal-title text-center\">Products List</h4>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<div class=\"subtitle\" >Products Selection</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"table-responsive ordertable\">\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Item Code</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Name</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Whole Sale Price</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Retail Price</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Currency</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Numbers of Capsules</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Business Volumes</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Qty</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Sel</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t   <tbody id=\"productsList\">\r\n");
      out.write("\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>A000000001</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>MT-1000</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>58$</td>\r\n");
      ...
      out.write("\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>90</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>40BV</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"number\" name=\"quantity\" min=\"1\" max=\"999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"checkbox\" data-id=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t     </tr>  \r\n");
      out.write("\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>A000000002</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>MT-1000 Second Generation</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>63$</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>82$</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>50</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>40BV</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"number\" name=\"quantity\" min=\"1\" max=\"999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"checkbox\" data-id=\"2\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t     </tr> \t\t\r\n");
      out.write("\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>A000000003</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>Rejwvenetor</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>65$</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>82$</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>60</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>40BV</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"number\" name=\"quantity\" min=\"1\" max=\"999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"checkbox\" data-id=\"3\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t     </tr>\t\r\n");
      out.write("\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>A000000004</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>Forever Young</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>95$</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>105$</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>CAD</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>50</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td>55BV</td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"number\" name=\"quantity\" min=\"1\" max=\"999\" value=\"1\"></td>\r\n");
      out.write("\t\t\t\t\t           \t\t<td><input type=\"checkbox\" data-id=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t     </tr>\t\t\t\t\t\t\t\t     \t\t\t\t     \t\t\t\t\t\t\t\t\t\t       \t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t     \t\t\t\t\t\t\t\t\t\t\t\t           \r\n");
      out.write("\t\t\t\t\t\t\t   </tbody>\r\n");
      out.write("\t\t\t\t\t\t\t </table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div>Dispaly results: <strong>1-10</strong> of <strong>20</strong></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul class=\"pagination pagination-sm\">\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li class=\"disabled\"><a href=\"#\"><span class=\"glyphicon glyphicon-step-backward\" style=\"line-height: inherit;\"></span></a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li class=\"disabled\"><a href=\"#\"><span class=\"glyphicon glyphicon-backward\" style=\"line-height: inherit;\"></span></a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li class=\"active\"><a href=\"#\">1</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li><a href=\"#\">2</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li><a href=\"#\">3</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li><a href=\"#\">4</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li><a href=\"#\">5</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li><a href=\"#\"><span class=\"glyphicon glyphicon-forward\" style=\"line-height: inherit;\"></span></a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t  <li><a href=\"#\"><span class=\"glyphicon glyphicon-step-forward\" style=\"line-height: inherit;\"></span></a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-footer\">\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary selectProducts\">Submit</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
