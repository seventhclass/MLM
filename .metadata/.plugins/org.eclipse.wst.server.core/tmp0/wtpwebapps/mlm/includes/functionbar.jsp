...
<div class='row'>
	...
	<div class='col-md-8'>
		<div class='col-sm-offset-7 col-sm-6'>
			<a class="myorder_btn" href='<%=request.getContextPath()%>/order/orderentry'><button type='button' class='btn btn-info'><span class='glyphicon glyphicon-list-alt'></span> My Order </button></a>
