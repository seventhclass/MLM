                ...
                <div id="content">
                    <div id="orderentry">
                        <div class="list-group">
                            <div class="list-group-item list-group-item-info active"><span
                                    class="glyphicon glyphicon-list-alt"></span> My Order
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <img style="width: 80px; height: 80px; padding: 10px;"
                                                             src="<%=request.getContextPath()%>/images/logo/shopping-cart-icon-transparent.png"
                                                             alt="shopping cart">
                                                    ...
                                                    <div class="col-sm-7 text-right">
                                                        <div class="row">
                                                            Shopping Cart Item: <span
                                                                id="shoppingCartItemNumber">3</span>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div id="order_cart">
                                                            <div class="row">
                                                                <a id="clearShoppingCart" href="#">[Clear]</a> <a
                                                                    id="checkoutShoppingCart" href="#">[Checkout]</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<div id="productlist" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
     aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"
                 style="background-color:#428bca;color:#fff;border-top-right-radius: 3px;border-top-left-radius: 3px;padding: 5px;">
                ...
                <div class="text-center">
                    <div id="pagination">
                        ...
                        <ul class="pagination pagination-sm">
                            <li class="disabled"><a href="#"><span class="glyphicon glyphicon-step-backward"
                                                                   style="line-height: inherit;"></span></a></li>
                            <li class="disabled"><a href="#"><span class="glyphicon glyphicon-backward"
                                                                   style="line-height: inherit;"></span></a></li>
                            ...
                            <li><a href="#">4</a></li>
                            <li><a href="#">5</a></li>
                            <li><a href="#"><span class="glyphicon glyphicon-forward"
                                                  style="line-height: inherit;"></span></a></li>
                            <li><a href="#"><span class="glyphicon glyphicon-step-forward"
                                                  style="line-height: inherit;"></span></a></li>
                        </ul>
                    </div>
                </div>
