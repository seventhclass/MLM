                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="userTotalOrderForm" class="form-horizontal" role="form" action="">
                                <div class="subtitle"><span style="color:#00FF00"
                                                            class='glyphicon glyphicon-credit-card'></span>&nbsp;&nbsp;Order
                                    Payment Selection
                                </div>
                                <div id="orderPaymentSection">
                                        ...
                                        <!--
                                         <div class="col-sm-2">
                                             <label class="radio-inline">
                                                 <input type="radio" name="optionspaytype" value="1" checked/>
                                                 Credit Card
                                             </label>
                                         </div>
                                         <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-2">
                                            <label class="radio-inline">
                                                <input type="radio" name="optionspaytype" value="2" checked/>
                                                Check
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-4">
                                        <a href="paymenttype.jsp">Edit Credit Card for <span
                                                class="p_userid">ABCDE00001</span></a><br/>
                                        <a href="payandship.jsp">Please refresh after adding a card</a>
                                    </div>
                                </div>
                                -->
                                <div class="subtitle"><span style="color:#00FF00"
                                                            class='glyphicon glyphicon-home'></span>&nbsp;&nbsp;Shipping
                                    Address Selection
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <span>Create or modify address - </span><a href="addressmaintenance.jsp">Go to
                                        Address Maintenance</a>
                                    </div>
                                </div>
                                -->
                                <div class="subtitle"><span style="color:#00FF00"
                                                            class='glyphicon glyphicon-plane'></span>&nbsp;&nbsp;Shipping
                                    Method Selection
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4">
